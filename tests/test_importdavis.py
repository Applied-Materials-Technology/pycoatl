...
filename = 'C:\\Users\\rspencer\\OneDrive - UK Atomic Energy Authority\\Experiments\\20200311_E97_Data\\E97_RT_Data\\B0001.csv'
test = pd.read_csv(filename,delimiter=';',encoding='Latin-1')
# %%
x = test['x [mm]'].to_numpy()
y = test['y [mm]'].to_numpy()
# %%
print(x[0],y[0])
print(x[1],y[1])
print(x[2],y[2])
...
# %%
folder = 'C:\\Users\\rspencer\\OneDrive - UK Atomic Energy Authority\\Experiments\\20200311_E97_Data\\E97_RT_Data'
loadfile = r'C:\Users\rspencer\OneDrive - UK Atomic Energy Authority\Experiments\20200311_E97_Data\E97_RT_Load\B0001.csv'
test3 = davis_to_spatialdata(folder,loadfile)
# %%
