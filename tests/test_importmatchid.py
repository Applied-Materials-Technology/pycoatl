...
def test_import_2023():
    ...
    sd.plot(data_field='displacement',component=[2],time_step=-1)
    sd.plot(data_field='total_strain',component=[1,1],time_step=-1)
...
def test_import_2024():
    ...
    sd.plot(data_field='displacement',component=[1],time_step=-1)
