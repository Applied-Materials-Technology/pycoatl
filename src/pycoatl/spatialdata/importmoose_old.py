...
def moose_to_spatialdata_seacas(exodus_file,fields=['disp_x','disp_y','disp_z','stress_yy','creep_strain_yy','plastic_strain_yy','mechanical_strain_xx','mechanical_strain_yy']):
