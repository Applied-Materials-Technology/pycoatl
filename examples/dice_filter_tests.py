...
best_file = Path.cwd()/'data/moose-sim-1_out.e'
...
input_file_name = Path.cwd()/'examples/ImDef/input.xml'
mod_file_name = input_file_name.parent /'input_mod.xml'
deformed_images = Path.cwd()/'examples/ImDef/deformed_images'
...
#%%
exodus_reader = ExodusReader(Path.cwd()/'examples/ImDef/results/DICe_solution.e')
all_sim_data = exodus_reader.read_all_sim_data()
